...
const displayMembers = (members) => {
  ...
  function showList(){
    ...
    document.getElementById("cards").style.display = "flex-direction", "column";
  ...
  function showList(){
    ...
    document.getElementById("cards").style.display = "grid-template-columns", " repeat(auto-fit, minmax(200px, 1fr));";
