...
// jeep 2-door
document.getElementById('jeep-two-h-r').innerText = data.reservation[4].hd;
document.getElementById('jeep-two-f-r').innerText = data.reservation[4].fd;
document.getElementById('jeep-two-h-w').innerText = data.walk[4].hd;
document.getElementById('jeep-two-f-w').innerText = data.walk[4].fd;
