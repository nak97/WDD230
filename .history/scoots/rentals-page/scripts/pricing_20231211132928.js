...
//  console.log(data)
 ...
 DocumentFragment.getElementById('dio-f-r').innerText = data.reservation[1].hd
 DocumentFragment.getElementById('dio-h-w').innerText = data.reservation[1].hd
 DocumentFragment.getElementById('dio-f-w').innerText = data.reservation[1].hd
