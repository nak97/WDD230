...
//   document.querySelector('#current-temp').innerHTML = response.main.temp;
// };
// getWeatherData();


const url =
"https://api.openweathermap.org/data/2.5/forecast?lat=20.51&lon=-86.94&hourly.dt=1702072800&cnt=3&appid=8dfd9f3c65a6ef4eaae72e5c410d646b&units=imperial";
...
async function weather(){
  ...
  document.querySelector('#current-temp').innerHTML = data.list[0].main.temp
  document.querySelector('#humidity').innerHTML = data.list[0].main.humidity
  document.querySelector('#current-description').innerHTML = data.list[0].weather[0].description
  document.querySelector('#icon').src =`https://openweathermap.org/img/wn/04n.png`
  document.querySelector('#temp-tomorrow').innerHTML = data.list[1].main.temp
